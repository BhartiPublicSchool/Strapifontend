...
import { getContactMailHtml, getFormTypeMailHtml } from 'utils';
import { Request, Response } from 'express';

// import { getContactMailHtml, getFormTypeMailHtml } from "./util";

// if(process.env.NODE_ENV != "PROD") {
const API_ENDPOINT = "http://206.189.133.72:81";

var smtpTransport = nodemailer.createTransport({
  // service: "Gmail",
//   host: process.env.MAILHOST,
  url: `${process.env.MAILHOST}:${process.env.MAILPORT}`,
